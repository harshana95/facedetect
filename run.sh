...
python main_train.py --model inc5 --dataset_path $ds --epochs $epochs $args --batch_size 64 &
sleep 2
python main_train.py --model inc4 --dataset_path $ds --epochs $epochs $args --batch_size 64 &
sleep 2
python main_train.py --model inc3 --dataset_path $ds --epochs $epochs $args --batch_size 64 &
sleep 2
